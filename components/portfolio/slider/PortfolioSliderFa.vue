			...
			<div class="content-slider slide-inner h-100 over-hidden">
				...
				<div ref="sliderContent"
					...
					<div :class="['slide-content p-absolute',store.slideCurrent === key ? 'dsn-active dsn-active-animate' : null]"
						...
						<LinkLine v-if="props.linkLine" linkName="مشاهده بیشتر" :linkTo="`${item.link}/${item.slug}`" parallax />

						<LinkDefualt v-if="props.linkDefualt" class="swiper-animate-head" linkName="مشاهده بیشتر"

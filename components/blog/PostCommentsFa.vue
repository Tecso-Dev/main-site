...
import PostCommentsFormFa from "./PostCommentsFormFa.vue";
    ...
    <div class="container">
        <div class="comments-post section-margin">
            <div class="comments-area section-margin">
                <div class="comments-title">
                    <h4 class="title-block line-shap line-shap-before">
                        <span v-if="props.data.comments.length > 0" class="line-bg-right">کامنت ها</span>
                        <span v-else class="line-bg-right">کامنتی وجود ندارد</span>
                    </h4>
                </div>
            ...
            <PostCommentsFormFa>
                <div class="comments-title">
                    <h4 class="title-block line-shap line-shap-before">
                        <span class="line-bg-right">کامنت بگذارید</span>
                    </h4>
                </div>
            </PostCommentsFormFa>
        </div>

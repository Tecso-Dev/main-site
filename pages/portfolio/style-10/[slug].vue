...
<template>
    ...
    <Layout>
        ...
        />
        <ParallaxImageTwo
            :src="item.images[4].src"
            :caption="item.images[4].name"
            fancybox="_1"
        />
        <!-- ========== End video  ========== -->        <!-- ========== Info  ========== -->
        <BoxInfoRight v-if="item.about[2]" :data="item.about[2]" />
        <!-- ========== End Info  ========== -->
        ...
        <ImagePopup
            class="dsn-container"
            mask
            :imageList="[item.images[1], item.images[3]]"
        />
        <!-- ========== End Image Popup  ========== -->

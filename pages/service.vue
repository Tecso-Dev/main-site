...
<template>
    ...
    <Layout bodyStyle="bg-dots">
        ...
        <!-- ========== Testimonials ================= -->
        <Testimonials :data="data_Teste" :stringLine="1" Pagination loop grabCursor :centeredSlides="false"
            className="section-padding background-section" slideClass="background-main" :desktop="{
                slidesPerView: 2,
                spaceBetween: 30,
